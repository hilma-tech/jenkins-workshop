...
app.get('/', (req, res) => {
    ...
    <h1 style="color:red;font-size:2rem;">DON'T USE THE SAME PASSWORD TWICE</h1>
    <div style="display:flex;">
    <div style="flex:3">
    <h4>Why not you ask? then let me tell you why</h4>
    <p>handing your precious password to a random site is very dangerous</p>
    <h3>A <b style="color:#f00; font-size: 1.6rem;font-weight: 1000">REAL</b> AND <span style="font-size:1.6rem;"><span style="color: #f00">T</span><span style="color: #f0f">E</span><span style="color: #0f0">R</span><span style="color: #0ff">R</span><span style="color: #00f">I</span><span style="color: #f0f">F</span><span style="color: #f00">Y</span><span style="color: #0ff">I</span><span style="color: #f0f">N</span><span style="color: #0f0">G</span> </span>STORY!</h3>
    ...
    How did this happen? well well, ill tell you. He entered a wonderful website that promised him a free delivery of flowers
     ...
     <div style="border: 1px solid green; padding: 0 1rem;background-color:#964B0030;">
     ...
     <p> From that day forward, Alex dedicated themselves to spreading awareness about password hygiene and digital security. Their harrowing experience served as a chilling reminder to all who heard their story - <i style="color:red;font-size:1.2rem;">a stark warning that the seemingly innocent act of reusing passwords could lead to unimaginable horrors in the darkest corners of the internet.</i></p>
     </p>
     </div>

</div>
     <div style="background-color:beige; border: solid 1px red;padding: 0 1rem; margin: 1rem;flex:1;">
    ...
    <input placeholder="type it here dont be shy"></input>
</body>`)
})
